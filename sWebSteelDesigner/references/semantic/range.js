    ...
    $.fn.range = function (parameters) {
        ...
        $allModules
            .each(function () {
                ...
                var
                    settings = ($.isPlainObject(parameters)) ? $.extend(true, {}, $.fn.range.settings, parameters) : $.extend({}, $.fn.range.settings),
                        ...
                        position: function (newPos, $element) {
                            ...
                            if (module.is.vertical()) {
                                if (module.is.reversed()) {
                                    $targetThumb.css({
                                        bottom: String(newPos - offset) + 'px'
                                    });
                                    if (module.is.doubled())
                                        trackPosValue = {
                                            bottom: String(parseFloat(module.determine.closestThumbPos(0)) + offset) + 'px'
                                        };
                                } else {
                                    $targetThumb.css({
                                        top: String(newPos - offset) + 'px'
                                    });
                                    if (module.is.doubled())
                                        trackPosValue = {
                                            top: String(parseFloat(module.determine.closestThumbPos(0)) + offset) + 'px'
                                        };
                                }
                                $trackFill.css(Object.assign({
                                    height: String(trackFillWidth) + 'px'
                                }, trackPosValue));
                            } else {
                                if (module.is.reversed()) {
                                    $targetThumb.css({
                                        right: String(newPos - offset) + 'px'
                                    });
                                    if (module.is.doubled())
                                        trackPosValue = {
                                            right: String(parseFloat(module.determine.closestThumbPos(0)) + offset) + 'px'
                                        };
                                } else {
                                    $targetThumb.css({
                                        left: String(newPos - offset) + 'px'
                                    });
                                    if (module.is.doubled())
                                        trackPosValue = {
                                            left: String(parseFloat(module.determine.closestThumbPos(0)) + offset) + 'px'
                                        };
                                }
                                $trackFill.css(Object.assign({
                                    width: String(trackFillWidth) + 'px'
                                }, trackPosValue));
                            }
